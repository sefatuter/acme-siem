...
exit 0
root@acme-server:~# cat /var/ossec/custom/bin/collect_rule100
collect_rule100150.sh  collect_rule100410.sh  collect_rule100432.sh  
root@acme-server:~# cat /var/ossec/custom/bin/collect_rule100432.sh 
#!/usr/bin/env bash
# collect_rule100432.sh — baseline snapshot for rule 100432
# Creates:  /var/ossec/baselines/100432/<tag>.txt
# --------------------------------------------------------------------
set -euo pipefail
